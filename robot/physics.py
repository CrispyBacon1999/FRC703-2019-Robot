...
class PhysicsEngine(object):
    ...
    def update_sim(self, hal_data, now, tm_diff):
        ...
        if elevator_last_pos > 200:
            hal_data["CAN"][robotmap.ELEVATOR["motors"][0]]["quad_position"] = int(elevator_last_pos + tick_diff * elevator_curr_set) - 5
        else:
            
            hal_data["CAN"][robotmap.ELEVATOR["motors"][0]]["quad_position"] = int(elevator_last_pos + tick_diff * elevator_curr_set)
